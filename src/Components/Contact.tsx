...
function Contact() {
  return (
    <div
      id="Contact"
      className="grid grid-cols gap-8 lg:grid-cols-4 md:grid-cols-4 sm:grid-cols-4 my-8 text-xs md:text-[14px] font-semibold text-[#4AC7F0]"
    >
      ...
      <div className="mx-20 mt-4 flex flex-row sm:flex-col gap-4 items-center">
        ...
        <a
          href="https://web.facebook.com/harkindeyley.harkinpelu"
          target="_blank"
        >
          <FaFacebook />
        </a>
        ...
        <a
          href="https://www.linkedin.com/in/akindele-ridwanullah-265329296/"
          target="_blank"
        >
          <FaLinkedin />
        </a>
